// ==UserScript==
// @name         AAA Dependended Services Finder
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  try to take over the world!
// @author       hczhang@
// @match        https://aaa.amazon.com/applications/*
// @include      https://aaa.amazon.com/applications/*
// @grant        hczhang@
// ==/UserScript==
...
(function() {
    ...
    aLink.onclick = function clickDownload(e) {
        console.log("start download");
        console.log(aLink);
        var text = CSVTransformer(result);
        text =  encodeURIComponent(text);
        e.srcElement.href = "data:text/csv;charset=utf-8,"+text;
    };
